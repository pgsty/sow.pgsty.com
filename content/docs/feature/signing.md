...
description: "Two independent trust chains, three ways to reference a key, in-process versus external signing, and what happens to your repository when you rotate a key."
