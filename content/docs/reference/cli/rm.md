...
[`sow ls`](/docs/reference/cli/query/) prints exact `sha256:` references and canonical coordinates,
...
`changes` is empty because nothing was built. Run [`sow build`](/docs/reference/cli/build/) to
converge.
...
- [sow ls / show / where](/docs/reference/cli/query/) — finding the exact reference to remove
