...
最终必须确定恰好一个仓库与至少一个目标 Dist——见[选择规则](/zh/docs/reference/cli/)。RPM 与 DEB
...
[`sow changes`](/zh/docs/reference/cli/build/) 中——只有成功的 build 才会把它们提升进可交付树。
...
- [sow rm](/zh/docs/reference/cli/rm/) —— 反向操作
