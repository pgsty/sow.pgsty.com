...
[`sow changes`](/docs/reference/cli/build/): `payload`, `metadata`, `pointer`, `delete`.
...
- [sow changes](/docs/reference/cli/build/) — the physical counterpart to a semantic Operation
