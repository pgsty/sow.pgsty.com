...
`files` 数组使用与 [`sow changes`](/zh/docs/reference/cli/build/) 相同的 `phase` 词表：`payload`、
...
- [sow changes](/zh/docs/reference/cli/build/) —— 语义 Operation 的物理对照物
