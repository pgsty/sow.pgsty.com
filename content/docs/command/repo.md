...
[Repository selection rules](/docs/command/#repository-selection) apply.
...
[`sow config check`](/docs/command/config/), and try again. There is no `--yes` and no
temporary override.
...
- [sow dist](/docs/command/dist/) — the layer below
